        ...
        <div className="row gap-5 justify-content-lg-between">
          <div className="col col-lg-4">
            <div className="text-center text-lg-start d-flex flex-column gap-4 position-relative">
              ...
              <p>
                Currently open for a full-time role, networking, and shadowing mentor opportunities. Freelance availability is dependent on potentially filling or creating a new project, whether it is open or private that I could
